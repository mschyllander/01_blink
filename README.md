...
| --- | --- | --- |
| ![Plasma and starfield running on the TFT](assets/display-plasma-running.png) | ![Breadboard wiring for the ESP32-C3 TFT demo](assets/breadboard-wiring.png) | ![Back of the ESP32-C3 development board](assets/esp32-c3-back.png) |
